...
function AccountUSTable() {
	...
	const handleAddAccount = async (newAccount: FrontendAccount) => {
		await setAccountData((prevTableData: FrontendAccount[]) => [...prevTableData, newAccount]);
	};
	...
	return (
		<div className="accountManagementSection">
			<h2 className="optionSubHeading">US Frontend</h2>
