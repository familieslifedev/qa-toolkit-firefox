	...
	return (
		<div className="complianceContainer">
			<div className={"btn-group btn-group-horizontal"}>
				<button className="btn btn-sm btn-primary" onClick={() => handleAnnotationBtnClicked(true)}>☑
					Annotations
				</button>
				<button className="btn btn-sm btn-primary" onClick={() => handleAnnotationBtnClicked(false)}>☐
					Annotations
				</button>
			</div>
