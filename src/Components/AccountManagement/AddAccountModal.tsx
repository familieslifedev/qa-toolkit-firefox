				...
				<div className="modal-box addAccountModal">
					...
					<form onSubmit={handleSubmit}>
						<div className="form-control">
							...
							<AddNewEntryInputComponent onClickFunction={randomFirstName} prettyName={"First Name"}
													   inputName={"firstName"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomSurname} prettyName={"Surname"}
													   inputName={"surname"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomEmail} prettyName={"Email Address"}
													   inputName={"emailAddress"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomContactNumber} prettyName={"Phone Number"}
													   inputName={"contactNumber"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomPostcode} prettyName={"Postcode"}
													   inputName={"postcode"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomHouseNumber} prettyName={"House Number"}
													   inputName={"houseNameNumber"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomAddressLine1}
													   prettyName={"Address Line 1"}
													   inputName={"addressLine1"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomAddressLine2}
													   prettyName={"Address Line 2"} inputName={"addressLine2"}
													   placeholder={"Optional"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomCounty} prettyName={"County"}
													   inputName={"county"}></AddNewEntryInputComponent>
							<AddNewEntryInputComponent onClickFunction={randomTownCity} prettyName={"Town/City"}
													   inputName={"townCity"}></AddNewEntryInputComponent>
						</div>
